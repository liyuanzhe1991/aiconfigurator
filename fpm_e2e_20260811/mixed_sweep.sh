...
# steps with chunk≈ISL. Windows marked in /results/mixed_windows.tsv.
set -uo pipefail
...
for BD in 8 16 32 40 64; do
  ...
  bench "$BD" 8192 1024 $((BD*14)) inf "/results/mx_long_bd${BD}.log" &
  LONG=$!
  ...
  for CHUNK in 256 512 1024 2048 4096 6144; do
    ...
    bench 1 "$CHUNK" 1 20 2.0 "/results/mx_probe_bd${BD}_c${CHUNK}.log"
